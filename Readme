# 📘 Spring AOP (Aspect Oriented Programming) – Backend Learning  
...
- **After Returning Advice** – Runs **after method returns successfully**
- **After Throwing Advice** – Runs **after method throws an exception**
...
- **CGLIB Proxy** – For classes without interfaces (like in this example)
